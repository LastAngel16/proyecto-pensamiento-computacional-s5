...
//Notas de avance madrugrada: Cuando copies un archivo asegurate de que este tenga todos los archivos consigo

//Variable unica para croc ya que su tamaño es diferente al de los demas

//añadido "&& faseDino === 2" para evitar que cuando se haga click al mouse este se salte el proceso del huevo, no tiene problemas con que se cargue si pasaba esto pero creo que si 
//fuera transparente se notaria
//se hizo que al hacer el comando de reset se reinicie todo incluyendo el contador del nacimiento del huevo y de el texto apareciendo
//se uso push y pop para haci lograr cargar el fondo y el sprite correspondiente al mismo tiempo para que coincidan y cargue mas rapido
// cambio de sistema de musica para que inicie independientemente de que se presione el click ya que causaba que se reproduciera el track al clickear
//Cambie la imagen de crack porque habia sido transparente una parte


//AVANCE FINAL 26 junio 2026 madrugada!!!
...
function preload() {
  ...
  //Solo los archivos Lab y crack tuvieron que ser cambiados por inconveniencias de tamaños y/o tranparencia
  lab1 = loadImage("./lab1v3.png");  
  lab2 = loadImage("./lab2v3.png");
  lab3 = loadImage("./lab3.png");
//Ninguna de las imagenes fueron hechos con IA, todas son hechas por mi 100% originales en pixel art
